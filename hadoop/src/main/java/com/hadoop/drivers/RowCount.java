...
import com.hadoop.mappers.RecordMapper;
import com.hadoop.reducers.NoKeyRecordCountReducer;
...
public class RowCount extends Configured implements Tool {
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println("=============** WordCount Driver Program Ends**==================");
		System.out.println("=============**Driver exitCode: "+exitCode+" **==================");
	...
	public int run(String[] args) throws Exception {
		...
		System.out.println("=============Driver args[0]:  "+args[0]+" **==================");
		System.out.println("=============Driver args[1]:  "+args[1]+" **==================");
